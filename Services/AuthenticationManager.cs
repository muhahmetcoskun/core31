...
namespace Services
{
    public class AuthenticationManager : IAuthenticationService
    {
        ...
        public AuthenticationManager(IRepositoryManager manager,
        ...
        public async Task<TokenDto> CreateToken(bool populateExp)
        {
            ...
            var kullaniciRol = await _manager.Authentication.GetAllAuthenticationAsync(false);


            return new TokenDto()
            {
                UserName = _user.UserName,  
                KullaniciYetki = kullaniciRol,
